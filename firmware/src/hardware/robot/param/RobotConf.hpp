...
constexpr float SERVO_ARM_LEFT_A_IDLE_ANGLE  = M_PI;  //TODO: CHANGE ME!
constexpr float SERVO_ARM_LEFT_B_IDLE_ANGLE  = M_PI;  //TODO: CHANGE ME!
constexpr float SERVO_ARM_LEFT_C_IDLE_ANGLE  = M_PI;  //TODO: CHANGE ME!
constexpr float SERVO_ARM_LEFT_D_IDLE_ANGLE  = M_PI;  //TODO: CHANGE ME!
constexpr float SERVO_ARM_LEFT_E_IDLE_ANGLE  = M_PI;  //TODO: CHANGE ME!
constexpr float SERVO_ARM_RIGHT_A_IDLE_ANGLE = M_PI;  //TODO: CHANGE ME!
constexpr float SERVO_ARM_RIGHT_B_IDLE_ANGLE = M_PI;  //TODO: CHANGE ME!
constexpr float SERVO_ARM_RIGHT_C_IDLE_ANGLE = M_PI;  //TODO: CHANGE ME!
constexpr float SERVO_ARM_RIGHT_D_IDLE_ANGLE = M_PI;  //TODO: CHANGE ME!
constexpr float SERVO_ARM_RIGHT_E_IDLE_ANGLE = M_PI;  //TODO: CHANGE ME!

constexpr float SERVO_RAKE_LEFT_TOP_IDLE_ANGLE = M_PI; //TODO: CHANGE ME!
constexpr float SERVO_RAKE_LEFT_BOTTOM_IDLE_ANGLE = M_PI; //TODO: CHANGE ME!
constexpr float SERVO_RAKE_RIGHT_TOP_IDLE_ANGLE = M_PI; //TODO: CHANGE ME!
constexpr float SERVO_RAKE_RIGHT_BOTTOM_IDLE_ANGLE = M_PI; //TODO: CHANGE ME!
